        ...
        <div class="slide-up mt-4" style="animation-delay: 100ms;">
            ...
            <div class="grid grid-cols-4 gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md">
                ...
                ${[1,2,3,4,5,6,7,8].map(i => 
                    `<img src="./assets/avatar${i}.svg" onclick="selectAvatar('avatar${i}')" class="avatar-option w-12 h-12 rounded-full cursor-pointer transition-all duration-200 ${state.currentUser.avatar===`avatar${i}` ? 'ring-4 ring-teal-500' : 'opacity-60 hover:opacity-100'}" id="avatar${i}-selector" alt="Avatar option ${i}">`
                ).join('')}
